...
{:else if name === "svelte"}
    <svg
        ...
        ><path
            d="M91.8 15.6A36 36 0 0 0 43.6 5.2L16.1 22.8A31.3 31.3 0 0 0 1.9 43.9a32.7 32.7 0 0 0 3.3 21.3 33.6 33.6 0 0 0 1 37.2 36 36 0 0 0 48.2 10.4l27.5-17.5a31.3 31.3 0 0 0 14.2-21.1c1.3-7.3.2-14.8-3.3-21.3a33 33 0 0 0-1-37.3"
...
{:else if name === "search"}
    <svg
        ...
        viewBox="0 0 20 20"
        ><path
            d="M8 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM2 8a6 6 0 1 1 10.9 3.5l4.8 4.8a1 1 0 0 1-1.4 1.4L11.5 13A6 6 0 0 1 2 8z"
        /></svg
    >
{:else}
